...
import {DragDropService,DragDropSortableService, DragDropData} from './service';

@Directive({ selector: '[dnd-sortable-container]' })
export class SortableContainer extends AbstractDnD {
...
export class SortableComponent extends AbstractDnD {
